...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'f5972290b926d26aaac64a516c8cb7ed7f3a7aa8dbccfb755e5cd69d814d1727'),
    ],
    ...
    'Datasources' => [
        ...
        'default' => [
            ...
            'driver' => Sqlite::class,
            'persistent' => false,
            'database' => WWW_ROOT . DS . 'fortunecookies.sqlite',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'flags' => [],
            'cacheMetadata' => true,
        ...
        'test' => [
            ...
            'driver' => Sqlite::class,
            'persistent' => false,
            'database' => WWW_ROOT . DS . 'test_fortunecookies.sqlite',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
